...
class CustomDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if self.mode == 'tot':
            ...
            assistant_pos1 = (input_ids1 == assistant_token_id).nonzero(as_tuple=True)[0].item()
            ...
            assistant_pos2 = (input_ids2 == assistant_token_id).nonzero(as_tuple=True)[0].item()
            ...
            assistant_pos3 = (input_ids3 == assistant_token_id).nonzero(as_tuple=True)[0].item()
            ...
            assistant_pos4 = (input_ids4 == assistant_token_id).nonzero(as_tuple=True)[0].item()
            ...
            assistant_pos = (input_ids == assistant_token_id).nonzero(as_tuple=True)[0].item()
